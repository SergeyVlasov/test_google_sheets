...
# сколько заявок создали менеджеры клубов
...
manager_of_club_column = pd.DataFrame(pd.read_csv(url_managers))['manager_id'].tolist()
club_of_manager_column = pd.DataFrame(pd.read_csv(url_managers))['d_club'].tolist()

def find_club_by_manager(manager):                  #найдем клуб по менеджеру
  index = manager_of_club_column.index(manager)
  return club_of_manager_column[index]

club_and_leads = {}

for manager in manager_and_lead:
  if manager != "00000000-0000-0000-0000-000000000000":
    if manager in manager_of_club_column:
      if club_and_leads.__contains__(find_club_by_manager(manager)):
        club_and_leads[find_club_by_manager(manager)] += manager_and_lead[manager]
      else:
        club_and_leads[find_club_by_manager(manager)] = manager_and_lead[manager]
    else:
      if club_and_leads.__contains__("No club"):
        club_and_leads["No club"] += manager_and_lead[manager]
      else:
        club_and_leads["No club"] = manager_and_lead[manager]
  else:
      if club_and_leads.__contains__("no club, managers 00000000-0000-0000-0000-000000000000"):
        club_and_leads["no club, managers 00000000-0000-0000-0000-000000000000"] += manager_and_lead[manager]
      else:
        club_and_leads["no club, managers 00000000-0000-0000-0000-000000000000"] = manager_and_lead[manager]
...
club_and_leads_trash = {}  # словарь клуб - сколько мусорных заявок

for manager in manager_and_lead_trash:
  if manager != "00000000-0000-0000-0000-000000000000":
    if manager in manager_of_club_column:
      if club_and_leads_trash.__contains__(find_club_by_manager(manager)):
        club_and_leads_trash[find_club_by_manager(manager)] += manager_and_lead_trash[manager]
      else:
        club_and_leads_trash[find_club_by_manager(manager)] = manager_and_lead_trash[manager]
    else:
      if club_and_leads_trash.__contains__("No club"):
        club_and_leads_trash["No club"] += manager_and_lead_trash[manager]
      else:
        club_and_leads_trash["No club"] = manager_and_lead_trash[manager]
  else:
      if club_and_leads_trash.__contains__("no club, managers 00000000-0000-0000-0000-000000000000"):
        club_and_leads_trash["no club, managers 00000000-0000-0000-0000-000000000000"] += manager_and_lead_trash[manager]
      else:
        club_and_leads_trash["no club, managers 00000000-0000-0000-0000-000000000000"] = manager_and_lead_trash[manager]
...
managers_and_lead_new= {}   #словарь клуб - сколько новых заявок
managers_new = []
...
for manager in managers_and_lead_new:
  if manager != "00000000-0000-0000-0000-000000000000":
    if manager in manager_of_club_column:
      if club_and_leads_new.__contains__(find_club_by_manager(manager)):
        club_and_leads_new[find_club_by_manager(manager)] += managers_and_lead_new[manager]
      else:
        club_and_leads_new[find_club_by_manager(manager)] = managers_and_lead_new[manager]
    else:
      if club_and_leads_new.__contains__("No club"):
        club_and_leads_new["No club"] += managers_and_lead_new[manager]
      else:
        club_and_leads_new["No club"] = managers_and_lead_new[manager]
  else:
      if club_and_leads_new.__contains__("no club, managers 00000000-0000-0000-0000-000000000000"):
        club_and_leads_new["no club, managers 00000000-0000-0000-0000-000000000000"] += managers_and_lead_new[manager]
      else:
        club_and_leads_new["no club, managers 00000000-0000-0000-0000-000000000000"] = managers_and_lead_new[manager]
...
club_and_leads_new_transaction = {}

for manager in managers_and_new_transactions:
  if manager != "00000000-0000-0000-0000-000000000000":
    if manager in manager_of_club_column:
      if club_and_leads_new_transaction.__contains__(find_club_by_manager(manager)):
        club_and_leads_new_transaction[find_club_by_manager(manager)] += managers_and_new_transactions[manager]
      else:
        club_and_leads_new_transaction[find_club_by_manager(manager)] = managers_and_new_transactions[manager]
    else:
      if club_and_leads_new_transaction.__contains__("No club"):
        club_and_leads_new_transaction["No club"] += managers_and_new_transactions[manager]
      else:
        club_and_leads_new_transaction["No club"] = managers_and_new_transactions[manager]
  else:
      if club_and_leads_new_transaction.__contains__("no club, managers 00000000-0000-0000-0000-000000000000"):
        club_and_leads_new_transaction["no club, managers 00000000-0000-0000-0000-000000000000"] += managers_and_new_transactions[manager]
      else:
        club_and_leads_new_transaction["no club, managers 00000000-0000-0000-0000-000000000000"] = managers_and_new_transactions[manager]
...
club_and_leads_new_transaction_week_after_lead = {}

for manager in managers_and_new_transactions_week_after_lead:
  if manager != "00000000-0000-0000-0000-000000000000":
    if manager in manager_of_club_column:
      if club_and_leads_new_transaction_week_after_lead.__contains__(find_club_by_manager(manager)):
        club_and_leads_new_transaction_week_after_lead[find_club_by_manager(manager)] += managers_and_new_transactions_week_after_lead[manager]
      else:
        club_and_leads_new_transaction_week_after_lead[find_club_by_manager(manager)] = managers_and_new_transactions_week_after_lead[manager]
    else:
      if club_and_leads_new_transaction_week_after_lead.__contains__("No club"):
        club_and_leads_new_transaction_week_after_lead["No club"] += managers_and_new_transactions_week_after_lead[manager]
      else:
        club_and_leads_new_transaction_week_after_lead["No club"] = managers_and_new_transactions_week_after_lead[manager]
  else:
      if club_and_leads_new_transaction_week_after_lead.__contains__("no club, managers 00000000-0000-0000-0000-000000000000"):
        club_and_leads_new_transaction_week_after_lead["no club, managers 00000000-0000-0000-0000-000000000000"] += managers_and_new_transactions_week_after_lead[manager]
      else:
        club_and_leads_new_transaction_week_after_lead["no club, managers 00000000-0000-0000-0000-000000000000"] = managers_and_new_transactions_week_after_lead[manager]
...
club_and_leads_new_transaction_amount = {}

for manager in managers_and_new_transactions_amount:
  if manager != "00000000-0000-0000-0000-000000000000":
    if manager in manager_of_club_column:
      if club_and_leads_new_transaction_amount.__contains__(find_club_by_manager(manager)):
        club_and_leads_new_transaction_amount[find_club_by_manager(manager)] += managers_and_new_transactions_amount[manager]
      else:
        club_and_leads_new_transaction_amount[find_club_by_manager(manager)] = managers_and_new_transactions_amount[manager]
    else:
      if club_and_leads_new_transaction_amount.__contains__("No club"):
        club_and_leads_new_transaction_amount["No club"] += managers_and_new_transactions_amount[manager]
      else:
        club_and_leads_new_transaction_amount["No club"] = managers_and_new_transactions_amount[manager]
  else:
      if club_and_leads_new_transaction_amount.__contains__("no club, managers 00000000-0000-0000-0000-000000000000"):
        club_and_leads_new_transaction_amount["no club, managers 00000000-0000-0000-0000-000000000000"] += managers_and_new_transactions_amount[manager]
      else:
        club_and_leads_new_transaction_amount["no club, managers 00000000-0000-0000-0000-000000000000"] = managers_and_new_transactions_amount[manager]
...
spisok_tblte = [club_and_leads_trash, 
                club_and_leads_new ,
                club_and_leads_new_transaction,
                club_and_leads_new_transaction_week_after_lead ,
                club_and_leads_new_transaction_amount ]

for key, value in club_and_leads.items():
    row_list = []
    row_list.append(key)
